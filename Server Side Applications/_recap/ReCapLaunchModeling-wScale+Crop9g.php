...
echo "<pre>";    
echo "\n------- ReCapLaunchModeling-wScale+Crop9g.php ------------------------------\n\n";
$outputString = "Scan processing by ReCapLaunchModeling-wScale+Crop9g.php.\n\n";
...
/*
 ...
 Revision 9g  -- supports scans with more than 41 images 
 ...
 and it will start-up a  separate callback program,  
 	ReCapRetrieveOBJ-v9g.php 
 also located in this same directory.
 
 ReCapRetrieveOBJ-v9g.php will check that ReCap created a model, and if it did, 
 it downloads the 3D model files as a 3DP and as an OBJ with texture map files. 
 ReCapRetrieveOBJ-v9g.php converts the OBJ to an STL format, and then sends a 
 ...
 * A doModelCropping boolean flag which controls whether the model will be cropped to the bounding box.
 ...
 and it will start-up a callback program  (also located in this same directory), called
 	...
 	/home/earchivevps/test.soundfit.me/apps/_recap/ReCapRetrieveOBJ-v9g.php, 
...
define ('CALLBACKPGM', 'http://test.soundfit.me/apps/_recap/ReCapRetrieveOBJ-v9g.php?scanID=');
...
// ----------------- END Write data to database ------------------------------------------	
	 ...
	 echo "\n-------- END OF ReCapLaunchModeling-wScale+Crop9g.php. ---------------\n\n";
