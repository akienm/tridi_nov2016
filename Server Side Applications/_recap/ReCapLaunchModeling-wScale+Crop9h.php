...
echo "<pre>";    
echo "\n------- ReCapLaunchModeling-wScale+Crop9h.php ------------------------------\n\n";
$outputString = "Scan processing by ReCapLaunchModeling-wScale+Crop9h.php.\n\n";
...
/*
 ...
 ReCapRetrieveOBJ-v9h.php will check that ReCap created a model, and if it did, 
 it downloads the 3D model files as a 3DP and as an OBJ with texture map files. 
 ReCapRetrieveOBJ-v9h.php converts the OBJ to an STL format, and then sends a 
 ...
 * A doModelCropping boolean flag which controls whether the model will be cropped to the bounding box.
 ...
 and it will start-up a callback program  (also located in this same directory), called
 	...
 	/home/earchivevps/test.soundfit.me/apps/_recap/ReCapRetrieveOBJ-v9h.php, 
...
define ('CALLBACKPGM', 'http://test.soundfit.me/apps/_recap/ReCapRetrieveOBJ-v9h.php?scanID=');
...
if ($errorflag) {
		 $to = $to;
		 $headers = "From: sugarcube-daemonapache2-nads.sawtelle.dreamhost.com";
...
// ----------------- END Write data to database ------------------------------------------	
	 ...
	 echo "\n-------- END OF ReCapLaunchModeling-wScale+Crop9h.php. ---------------\n\n";
