...
foreach ( $modelledDir as $modelDir ) {
	...
	$thisModelArray["spreadFOVx"]		= $thisModelArray["maxFOVx"]-$thisModelArray["minFOVx"];
	...
	$thisModelArray["spreaddiffRotation"]		= $thisModelArray["maxdiffRotation"]-$thisModelArray["mindiffRotation"];
	...
	$thisModelArray["spreaddiffElevation"]		= $thisModelArray["maxdiffElevation"]-$thisModelArray["mindiffElevation"];
...
foreach ($transposedMetrics as $rowTitle => $rowValueArray) {
	if (is_numeric($rowValueArray[0])) {
		$rowValueArray["max"] = max($rowValueArray);
		$rowValueArray["min"] = min($rowValueArray);
		$rowValueArray["mean"] = calculate_average($rowValueArray);
		$rowValueArray["median"] = calculate_median($rowValueArray);
		$rowValueArray["spread"] = $maxValue -$minValue;
		$rowValueArray["std dev"] = standard_deviation($rowValueArray);
		$rowValueArray["title"] = $rowTitle;
	} else {
		$rowValueArray["max"] = "";
		$rowValueArray["min"] = "";
		$rowValueArray["mean"] = "";
		$rowValueArray["median"] = "";
		$rowValueArray["spread"] = "";
		$rowValueArray["std dev"] = "";
		$rowValueArray["title"] = "";
	} 
}	
...
echo "\n------- END metricsForReference3DPs2.php ------------------------------\n\n";
