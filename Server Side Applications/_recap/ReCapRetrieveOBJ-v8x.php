...
$received_dir_root =  '/home/earchivevps/test.soundfit.me/Scans/x3/received/';
$ReceivedURL = "http://test.soundfit.me/Scans/x3/received/";

$modeled_dir_root =  '/home/earchivevps/test.soundfit.me/Scans/x3/modeled/';
$ModeledURL =  'http://test.soundfit.me/Scans/x3/modeled/';
$errorflag = false;

$mapdir = '/home/earchivevps/test.soundfit.me/Scans/x3/maps/';
...
$emailmapdir = '/home/earchivevps/test.soundfit.me/Scans/x3/emailmaps/';
...
if (file_exists($emailmapfile)) {
    ...
    // $photosceneID = $xml->to;
 	...
 	$shootingString = $xml->shootingString;
 	$doImageCropping = $xml->doImageCropping;
 	$imageCroppingRectangle = $xml->imageCroppingRectangle;
 	$doModeScaling = $xml->doModeScaling;
 	$doModelCropping = $xml->doModelCropping;
 	$boundingbox = $xml->boundingbox;
 	$callbackProgram = $xml->callbackProgram;
 	...
 	*/
	copy ( $emailmapfile, $ModeledURL.$scanID );
} else {
...
echo "\n------- End of ReCapRetrieveOBJ-v8x.php -----------------------------------\n\n";
echo "</pre>";
exit ;
?>
