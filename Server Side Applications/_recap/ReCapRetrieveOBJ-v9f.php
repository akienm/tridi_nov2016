...
echo "<pre>";
echo "\n------- ReCapRetrieveOBJ-v9f.php -----------------------------------\n\n";
$output_string = "Model retrieved by ReCapRetrieveOBJ-v9f.php.\n\n";  

/*
 ReCapRetrieveOBJ-v9e.php
...
if ($xml->Error) { // if error print and quit gracefully
	...
	symlink($RECEIVEDDIR . "/template-$scanID.3dp",	$scan_directory. "/template.3dp");
...
if ($errorflag == false) {  // If we get here there SHOULD be an OBJ to download
	...
	$DiffPageString = $DiffPageString 
				...
				. "Automated template = <a href='".$templateXMLFile."'>$templateXMLFile</a><br />"
...
echo "\n------- End of ReCapRetrieveOBJ-v9f.php -----------------------------------\n\n";
echo "</pre>";
exit ;
?>
