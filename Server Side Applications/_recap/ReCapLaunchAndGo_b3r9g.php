<?php
	...
	//echo "<pre>\n";
	//echo "----------------------- START OF ReCapLaunchAndGo_b3r9h.php -----------------\n";
	
	// ReCapLaunchAndGo_b3r8g.php
	...
	// ReCapLaunchModeling-wScale+Crop8g.phpprogram which will be launched in a shell
	...
	define ('LAUNCHPGM', '/home/earchivevps/test.soundfit.me/apps/_recap/ReCapLaunchModeling-wScale+Crop9h.php');
 	...
 	if ($logsdir) {
		...
		// $shellcmd = 'nohup nice -n 10 /usr/local/php53/bin/php -f /home/earchivevps/test.soundfit.me/apps/_recap/ReCapLaunchModeling-wScale+Crop9h.php ' . $queryArgString . ' > /dev/null 2>/dev/null & printf "%u" $!';
		...
		//echo "----------------------- END OF ReCapLaunchAndGo_b3r9h.php -----------------\n";	
		//echo "</pre>";
		exit ($pid) ;
