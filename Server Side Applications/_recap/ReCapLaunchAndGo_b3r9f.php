<?php
	...
	//echo "<pre>\n";
	//echo "----------------------- START OF ReCapLaunchAndGo_b3r9f.php -----------------\n";
	
	// ReCapLaunchAndGo_b3r8f.php
	...
	define ('LAUNCHPGM', '/home/earchivevps/test.soundfit.me/apps/_recap/ReCapLaunchModeling-wScale+Crop9f.php');
 	...
 	if ($logsdir) {
		...
		//echo "----------------------- END OF ReCapLaunchAndGo_b3r9f.php -----------------\n";	
		//echo "</pre>";
		exit ($pid) ;
