...
/*
 ...
 current directory where it is run (currently  the "apps/_recap" directory).  
 It then uses that token to create a new token good for another day, which it
 writes back into the same location.
...
define ('BaseUrl' ,'https://accounts.autodesk.com/') ; // https://accounts.autodesk.com/ or https://accounts-staging.autodesk.com/
